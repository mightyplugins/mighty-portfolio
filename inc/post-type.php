...
*/
class CT_Portfolio_Post_Type
{
	
	function __construct()
	{
		// Register post type
		add_action( 'init', array($this, 'ct_register_post_type') );
		add_action( 'init', array($this, 'ct_register_portfolio_category') );

		// Add custom column to portfolio list 
		add_action( 'manage_mp-portfolio_posts_columns', array($this, 'ct_add_custom_columns') );

		add_action( 'manage_mp-portfolio_posts_custom_column', array($this, 'ct_render_custom_column'), 10, 2 );
	}
	...
	public function ct_register_portfolio_category()
	{
	...
	function ct_add_custom_columns( $columns )
	{
	...
	function ct_render_custom_column( $column_name, $post_id )
	{
...
$post_type = new CT_Portfolio_Post_Type();